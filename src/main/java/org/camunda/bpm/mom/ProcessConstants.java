...
public class ProcessConstants {
  ...
  public static final String PROCESS_KEY_task = "task";
  
  public static final String VAR_NAME_DESCRIPTION = "description";
  public static final String VAR_NAME_priority = "priority";
